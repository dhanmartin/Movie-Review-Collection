...
from app.views.common import debug_exception
...
def read_reviews(request, page_no=0, keyword=None) -> dict:
    ...
    try:
        ...
        for bookmark in bookmarks:
            key = "{}{}{}".format(
                bookmark.data.get("byline"),
                bookmark.data.get("display_title"),
                bookmark.data.get("publication_date"),
            )
        ...
        results = {"records": records, "has_more": data.get("has_more")}
        return results
    except Exception as e:
        debug_exception(e)
        raise e
